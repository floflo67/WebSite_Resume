...
namespace MyResume.Models
{
    public class CourseModels
    {
        ...
        /// <summary>
        /// CourseModels constructor
        /// </summary>
        /// <param name="_school">School name</param>
        ...
        public CourseModels(string _school, string _city, string _title, string _comment, DateTime _startDate, DateTime _endDate, List<JobTechnology> _technologiesUsed)
        {
            this.School = _school;
            this.City = _city;
            this.Title = _title;
